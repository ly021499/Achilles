...
class InstanceProxy:
    ...
    @log.wrap('验证【茫然遗迹-比娜】副本所有关卡的能量消耗是否正确及战斗奖励是否与运营配置符合')
    ...
    @log.wrap('验证【茫然遗迹-切斯特】副本所有关卡的能量消耗是否正确及战斗奖励是否与运营配置符合')
    ...
    @log.wrap('验证【茫然遗迹-戈乌拉】副本所有关卡的能量消耗是否正确及战斗奖励是否与运营配置符合')
    ...
    @log.wrap('验证【茫然遗迹-巴比艾尔】副本所有关卡的能量消耗是否正确及战斗奖励是否与运营配置符合')
    ...
    @log.wrap('验证【元素峡谷-冰元素】副本所有关卡的能量消耗是否正确及战斗奖励是否与运营配置符合')
    ...
    @log.wrap('验证【虚影殿堂-法师试炼】副本所有关卡的能量消耗是否正确及战斗奖励是否与运营配置符合')
    ...
    @log.wrap('验证【虚影殿堂-增援者试炼】副本所有关卡的能量消耗是否正确及战斗奖励是否与运营配置符合')
    ...
    # @log.wrap('验证【虚影殿堂-战士试炼】副本所有关卡的能量消耗是否正确及战斗奖励是否与运营配置符合')
    # def verify_brush_instance_of_support(self):
    #     self.reward.brush_instance(
    #         Shadow.shadow_keep_pos, Shadow.shadow_keep_level_pos,
    ...
    #     )
    #
    @log.wrap('验证【贪婪禁地-药水研究所】副本所有关卡的能量消耗是否正确及战斗奖励是否与运营配置符合')
    ...
    @log.wrap('验证【贪婪禁地-黄金谷】副本所有关卡的能量消耗是否正确及战斗奖励是否与运营配置符合')
