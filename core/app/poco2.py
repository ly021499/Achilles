...
class Poco2(Poco):
    ...
    def wait_for_any(self, objects, timeout: int = 120):
        try:
    ...
    def wait_for_all(self, objects, timeout: int = 120):
        try:
    ...
    def swipe(self, p1, p2=None, direction=None, duration: float = 2.0):
        try:
    ...
    def scroll(self, direction: str = 'vertical', percent: float = 0.6, duration: float = 2.0):
        try:
    ...
    def start_gesture(self, pos: str):
        try:
    ...
    def apply_motion_tracks(self, tracks, accuracy: float = 0.004):
        try:
