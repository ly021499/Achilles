...
# 元素峡谷：关卡等级、冰元素、火元素、风元素、土元素
elemental_valley_pos = 'textMatches=元素峡谷'
elemental_valley_level_pos = '15'
frost_lord_pos = 'textMatches=冰元素'
pyro_lord_pos = 'textMatches=火元素'
gale_lord_pos = 'textMatches=风元素'
stone_lord_pos = 'textMatches=土元素'

# 贪婪禁地：药水研究所关卡等级、药水研究所、黄金谷、黄金谷关卡等级、黄金谷金钥匙
forbidden_sector_pos = 'textMatches=贪婪禁地'
potion_pos = 'textMatches=药水研炼所'
potion_level_pos = '18'
the_gold_pos = 'textMatches=黄金谷'
the_gold_level_pos = '8'
golden_key_count_pos = 'nameMatches=TextLabel43'

# 虚影殿堂：关卡等级、捍卫者试炼、增援者试炼、射手试炼、法师试炼、刺客试炼、战士试炼
the_shadow_keep_pos = 'textMatches=虚影殿堂'
the_shadow_keep_level_pos = '8'
...
# 茫然遗迹：关卡等级、比那、切斯特、戈乌拉、巴比艾尔
lost_sector_pos = 'textMatches=茫然遗迹'
lost_sector_level_pos = '20'
